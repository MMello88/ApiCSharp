...
namespace lab.Infra.Data.Config.BlocoA
{
	public class RegA170EFDCConfiguration : IEntityTypeConfiguration<RegA170EFDC>
	{
		public void Configure(EntityTypeBuilder<RegA170EFDC> builder)
		{
			...
			builder.HasOne(_A170 => _A170.Reg0200EFDC);
			builder.HasOne(_A170 => _A170.Ref431); 
			builder.HasOne(_A170 => _A170.Ref433);
			...
			builder.HasOne(_A170 => _A170.Ref434);
			...
			builder.HasOne(_A170 => _A170.Reg0500EFDC);
			builder.HasOne(_A170 => _A170.Reg0600EFDC);
		}
	}
}
